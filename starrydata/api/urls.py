...
urlpatterns = [
    ...
    path('polymer_tags/<int:pk>', views.PolymerTagDetailView.as_view(), name='PolymerTagDetailView'),
    ...
    path('polymer_tag_tree/<int:pk>', views.PolymerTagTreeDetailView.as_view(), name='PolymerTagTreeDetailView'),
